...
namespace PerfectlyNormalBaS
{
    ...
    public static class Math2D
    {
        ...
        /// </summary>
        private static Plane? GetPlane_Average(Vector3[] points, bool matchPolyNormalDirection = false)
        {
            //return AveragePlane.GetAveragePlane(points, matchPolyNormalDirection);
            throw new ApplicationException("This relies on GeneticSharp.  See PerfectlyNormalUnity for what was deleted from PerfectlyNormalBaS");
        }
        /// <summary>
        ...
        /// </remarks>
        private static Polygon2D[] GetUnion_Polygons(Vector2[][] polygons)
        {
            throw new ApplicationException("This relies on clipper.  See PerfectlyNormalUnity for what was deleted");
        }
